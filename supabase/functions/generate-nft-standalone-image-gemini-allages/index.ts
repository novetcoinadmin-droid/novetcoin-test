  ...
  if (
    ...
    return {
      ...
      lines: [
        ...
        "Use high-end Japanese anime fantasy character concept art quality: premium gacha character illustration, official game promotional standing artwork, polished anime-style rendering, not a photorealistic real person and not heavy 3D/CG armor rendering.",
        ...
        "Use a beautiful Japanese anime-style face with refined attractive features and a confident cool expression. Make the character look stylish, heroic, and high-rarity, while still clearly being the same character.",

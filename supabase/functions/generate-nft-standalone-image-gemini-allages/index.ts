  ...
  if (isSdToPhotorealIntermediateMode(mode)) {
    return {
      ...
      lines: [
        ...
        "Strict body and age lock: replace the SD/chibi body completely with an exactly 10-heads-tall photorealistic adult fashion-model body, around 25 years old. Use a tall adult fashion-model physique that looks over 180cm tall, mature face, adult bone structure, high waistline, long legs, long neck, broader adult shoulders, and confident adult presence. The head must be about 1/10 of full body height, and the legs should occupy about 55 to 60 percent of full body height. Do not preserve the chibi silhouette, chibi head size, short limbs, short legs, low waistline, childlike face, teenage face, low height, mascot body, anime body, or game-icon look.",
        "Preserve only the reference pose and composition: same stance, same camera angle, torso direction, head direction, arm positions, hand-held equipment positions, left/right hand assignment, equipment angle, and cape/back direction. Recalculate the anatomy and body proportions from scratch as a tall 10-heads adult fashion model; do not keep the SD silhouette, SD body ratio, short legs, or low waistline.",

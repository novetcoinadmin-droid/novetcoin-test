...
window.addEventListener("load", async () => {
    ...
    if (profile) {
        panel.innerHTML = `
            ...
            <a href="account.html" class="right-btn" style="display:block; text-align:center; background:#6a0dad; color:white; padding:8px; text-decoration:none; border-radius:5px; margin-bottom:10px;">マイページ / お財布</a>
